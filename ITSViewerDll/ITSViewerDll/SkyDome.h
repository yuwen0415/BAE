...
public:
	...
	SkyDome( float radius, unsigned int longSteps, unsigned int latSteps, osg::TextureCubeMap* cubemap ,osgViewer::Viewer *vw);

protected:
	~SkyDome(void);
	
public:
	void setupStateSet( osg::TextureCubeMap* cubemap, osgViewer::Viewer *vw);
	void create( float radius, unsigned int latSteps, unsigned int longSteps, osg::TextureCubeMap* cubemap, osgViewer::Viewer *vw);
