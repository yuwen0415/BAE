...
{
    public partial class AccessorialMaterialMnt : TPageBase
    {
        ...
        {
            var list = this.EntityContext.Value.SearchAccessorialMaterials();
        ...
        public override bool DeleteRows()
        {
            ...
            {
                this.EntityContext.Value.DeleteAccessorialMaterial(id);
            }
