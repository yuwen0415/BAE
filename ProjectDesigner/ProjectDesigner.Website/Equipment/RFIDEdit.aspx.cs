...
{
    public partial class RFIDEdit : TPageBase
    {
        ...
        protected override void OnAdd()
        {
            if (!IsPostBack)
            {
                this.EditModel = this.EntityContext.Value.RFIDs.NewEntity();
            }
        }
        ...
        protected override void OnEdit()
        {
            if (!IsPostBack)
            {
                this.EditModel = this.EntityContext.Value.SearchRFID(this.SelectedId);
            }
        }
        ...
        {
            this.EntityContext.Value.UpdateRFID(this.EditModel);
            return this.EditModel;
        }

        protected override object AddObject()
        {
            this.EntityContext.Value.AddRFID(this.EditModel);
            return this.EditModel;
        }
