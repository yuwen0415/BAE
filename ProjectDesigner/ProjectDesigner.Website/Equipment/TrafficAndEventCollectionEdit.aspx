    ...
    <div class="edit_new">
        <div>
            ...
            <div class="row">
                <div>
                    <label>
                        采集设备</label><asp:TextBox ID="txtTrafficAndEventCollection" CssClass="combobox" data-dialog-url="../Popup/SelectTrafficAndEventCollectionEquipment.aspx"
                            data-callback-fields='{"Name":"#txtTrafficAndEventCollection"}' data-search-method="FindSelectTrafficAndEventCollectionEquipment"
                            data-dialog-height='550' data-dialog-width='680' ClientIDMode="Static" data-columns='{"Name": "名称" }'
                            runat="server" Width="325px"></asp:TextBox>
                </div>
                <div>
                    <label>
                        采集设备类型</label>
                    <asp:DropDownList runat="server" ID="DropListTrafficAndEventCollectionEquipmentType" ClientIDMode="Static" Width="325px">
            ...
            <div class="row">
                <div>
                    <label>
                        采集设备个数</label><asp:DropDownList runat="server" ID="DropDownListTrafficAndEventCollectionEquipmentNum" ClientIDMode="Static" Width="325px">
                ...
                if (editType == "add") {
                    ...
                    $.each(url_params, function (n, value) {
                        if (value.indexOf("id") > -1) {
                            id = value.substring(value.indexOf("id") + 3, value.length);
                        }
                    });

                    $(this).ajaxPost({
                        method: 'AddMaterials', params: { 'Id': id, 'dataBaseTableIds': dataBaseTableIds }, 'callback': function (data) {
                            if (data != null) {
                    ...
                    $(this).ajaxPost({
                        method: 'UpdateMaterial', params: { 'Id': equipmentId, 'equipmentTableId': ids[0] }, 'callback': function (data) {
                            if (data != null) {
