...
{
    public partial class CenterEquipmentEdit : TPageBase
    {
        ...
        protected override void OnAdd()
        {
            if (!IsPostBack)
            {
                this.EditModel = this.EntityContext.Value.CenterEquipments.NewEntity();
            }
        }
        ...
        protected override void OnEdit()
        {
            if (!IsPostBack)
            {
                this.EditModel = this.EntityContext.Value.SearchCenterEquipment(this.SelectedId);
            }
        }
        ...
        {
            this.EntityContext.Value.UpdateCenterEquipment(this.EditModel);
            return this.EditModel;
        }

        protected override object AddObject()
        {
            this.EntityContext.Value.AddCenterEquipment(this.EditModel);
            return this.EditModel;
        }
        ...
        public object Save()
        {
            try
            {
                ...
                this.FillData();
                this.SaveObject<ICenterEquipment>();
