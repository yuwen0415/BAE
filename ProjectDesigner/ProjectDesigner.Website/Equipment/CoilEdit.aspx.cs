...
{
    public partial class CoilEdit : TPageBase
    {
        ...
        protected override void OnAdd()
        {
            if (!IsPostBack)
            {
                this.EditModel = this.EntityContext.Value.Coils.NewEntity();
            }
        }
        ...
        protected override void OnEdit()
        {
            if (!IsPostBack)
            {
                this.EditModel = this.EntityContext.Value.SearchCoil(this.SelectedId);
            }
        }
        ...
        {
            this.EntityContext.Value.UpdateCoil(this.EditModel);
            return this.EditModel;
        }

        protected override object AddObject()
        {
            this.EntityContext.Value.AddCoil(this.EditModel);
            return this.EditModel;
        }
