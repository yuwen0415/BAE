<%@ Page Title="视频监控" Language="C#" AutoEventWireup="true" CodeBehind="VideoSurveillanceMnt.aspx.cs"
    Inherits="ProjectDesigner.Website.Equipment.VideoSurveillanceMnt" MasterPageFile="~/Main.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="main-content">
        ...
        <div class="tool_button">
            <asp:Button CssClass="button_out add-link" runat="server" ID="btnAdd" URL="VideoSurveillanceEdit.aspx"
                data-dialog-width="974" data-dialog-height="663" Text="新 增" />
        </div>
        <div class="tool_button">
            <asp:Button CssClass="button_out edit-link" runat="server" ID="btnUpdate" URL="VideoSurveillanceEdit.aspx"
                data-dialog-width="974" data-dialog-height="663" Text="修 改" />
        </div>
        <div class="tool_button">
            <asp:Button CssClass="button_out view-link" runat="server" ID="btnView" URL="VideoSurveillanceEdit.aspx"
        ...
        <table border="0" cellpadding="0" cellspacing="1" class="gridview" data-name="" data-multiselect="true"
            ...
            <thead>
                <tr>
                    ...
                    <th class="word-4" data-field="VideoSurveillanceType" data-sorting="fixed">
                        <a href="#">类型</a>
                    </th>
                </tr>
            </thead>
