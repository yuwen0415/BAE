...
{
    public partial class ConstructionMaterialEdit : TPageBase
    {
        ...
        protected override void OnAdd()
        {
            if (!IsPostBack)
            {
                this.EditModel = this.EntityContext.Value.ConstructionMaterials.NewEntity();
            }
        }
        ...
        protected override void OnEdit()
        {
            if (!IsPostBack)
            {
                this.EditModel = this.EntityContext.Value.SearchConstructionMaterial(this.SelectedId);
            }
        }
        ...
        {
            this.EntityContext.Value.UpdateConstructionMaterial(this.EditModel);
            return this.EditModel;
        }

        protected override object AddObject()
        {
            this.EntityContext.Value.AddConstructionMaterial(this.EditModel);
            return this.EditModel;
        }
