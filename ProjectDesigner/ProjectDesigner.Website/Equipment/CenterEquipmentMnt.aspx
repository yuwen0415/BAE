<%@ Page Title="辅材" Language="C#" AutoEventWireup="true" CodeBehind="CenterEquipmentMnt.aspx.cs"
    Inherits="ProjectDesigner.Website.Equipment.CenterEquipmentMnt" MasterPageFile="~/Main.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="main-content">
        ...
        <div class="tool_button">
            <asp:Button CssClass="button_out add-link" runat="server" ID="btnAdd" URL="CenterEquipmentEdit.aspx"
                data-dialog-width="974" data-dialog-height="663" Text="新 增" />
        </div>
        <div class="tool_button">
            <asp:Button CssClass="button_out edit-link" runat="server" ID="btnUpdate" URL="CenterEquipmentEdit.aspx"
                data-dialog-width="974" data-dialog-height="663" Text="修 改" />
        </div>
        <div class="tool_button">
            <asp:Button CssClass="button_out view-link" runat="server" ID="btnView" URL="CenterEquipmentEdit.aspx"
