...
{
    public partial class ConstructionMaterialMnt : TPageBase
    {
        ...
        {
            var list = this.EntityContext.Value.SearchConstructionMaterials();
        ...
        public override bool DeleteRows()
        {
            ...
            {
                this.EntityContext.Value.DeleteConstructionMaterial(id);
            }
