    ...
    <div class="edit_new">
        <div>
                ...
                <div>
                    <label>
                        类型</label><asp:DropDownList runat="server" ID="DropDownListType" ClientIDMode="Static" Width="325px">
                            ...
                            <asp:ListItem Value="3">区间测速</asp:ListItem>
                            <asp:ListItem Value="4">单点测速</asp:ListItem>
                        </asp:DropDownList>
                </div>
                <div>
                    <label>
            ...
            <div>
                ...
                <input id="btnCannel" name="" type="button" class="button_out" runat="server"
                    clientidmode="Static" value="取 消" />
            </div>
            <div>
                <h3>待选择的设备辅材和工程辅材
                </h3>
                ...
                <table border="0" cellpadding="0" cellspacing="1" class="gridview" data-multiselect="true"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="word-16" data-field="TechnicalParameters" data-sorting="fixed">
                                <a href="#">技术参数</a>
                            </th>
                            <th class="word-4" data-field="Brand" data-sorting="fixed">
                                <a href="#">设备品牌</a>
