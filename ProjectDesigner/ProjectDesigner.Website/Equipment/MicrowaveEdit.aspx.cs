...
{
    public partial class MicrowaveEdit : TPageBase
    {
        ...
        protected override void OnAdd()
        {
            if (!IsPostBack)
            {
                this.EditModel = this.EntityContext.Value.Microwaves.NewEntity();
            }
        }
        ...
        protected override void OnEdit()
        {
            if (!IsPostBack)
            {
                this.EditModel = this.EntityContext.Value.SearchMicrowave(this.SelectedId);
            }
        }
        ...
        {
            this.EntityContext.Value.UpdateMicrowave(this.EditModel);
            return this.EditModel;
        }

        protected override object AddObject()
        {
            this.EntityContext.Value.AddMicrowave(this.EditModel);
            return this.EditModel;
        }
