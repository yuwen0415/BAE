...
{
    public partial class CenterEquipmentMnt : TPageBase
    {
        ...
        {
            var list = this.EntityContext.Value.SearchCenterEquipments();
        ...
        public override bool DeleteRows()
        {
            ...
            {
                this.EntityContext.Value.DeleteCenterEquipment(id);
            }
