<%@ Page Title="工程施工材料" Language="C#" AutoEventWireup="true" CodeBehind="ConstructionMaterialMnt.aspx.cs"
    Inherits="ProjectDesigner.Website.Equipment.ConstructionMaterialMnt" MasterPageFile="~/Main.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="main-content">
        ...
        <div class="tool_button">
            <asp:Button CssClass="button_out add-link" runat="server" ID="btnAdd" URL="ConstructionMaterialEdit.aspx"
                data-dialog-width="974" data-dialog-height="663" Text="新 增" />
        </div>
        <div class="tool_button">
            <asp:Button CssClass="button_out edit-link" runat="server" ID="btnUpdate" URL="ConstructionMaterialEdit.aspx"
                data-dialog-width="974" data-dialog-height="663" Text="修 改" />
        </div>
        <div class="tool_button">
            <asp:Button CssClass="button_out view-link" runat="server" ID="btnView" URL="ConstructionMaterialEdit.aspx"
...
<%--                    <th class="word-6" data-field="ProductType" data-sorting="fixed">
                        <a href="#">型号</a>
                    </th>--%>
...
<%--                    <th class="word-4" data-field="Brand" data-sorting="fixed">
                    ...
                    <th class="word-4" data-field="Unit" data-sorting="fixed">
                        <a href="#">单位</a>
                    </th>
