         ...
         _create: function () {
			...
			type = input.attr('type');
             ...
             if (!input.is('input') || ((type != 'text') && (type != 'number'))) {
                 alert('Invalid target for ui.spinner');
                 return;
             }
         ...
         _createButtons: function (input) {
			...
			rtl = input[0].dir == 'rtl';
             ...
             wrapper.append(btnContainer.css({ height: height, left: -buttonWidth - rightMargin
                 ...
                 //,top: btnContainer_top + 'px'
             })); 

             //TODO: ie8 
             var btnContainer_top = input.offset().top - wrapper.offset().top;
             //if (wrapper.parent().is('td')) {
                 btnContainer_top = btnContainer_top == 0 || btnContainer_top > 1 ? -input.height() + 3 : btnContainer_top;
             //}
             btnContainer.css('top', btnContainer_top + 'px');

             buttons = self.buttons = btnContainer.find('.ui-spinner-button');
             buttons.css({ margin: 0, padding: 0 });
